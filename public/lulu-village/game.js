...
const QUESTIONS = [
  ...
  { s:"📖 語文", q:"「快樂」的注音第一個字是？", o:["ㄑㄩ","ㄎ","ㄑ","ㄍ"], a:2 },
  ...
  { s:"🌿 自然", q:"蝴蝶成蟲前的階段叫？", o:["幼蟲→毛毛蟲→蛹","毛毛蟲→幼蟲→蛹","蛹→毛毛蟲","毛毛蟲→蛹（正確）"], a:3 },
  ...
  { s:"🏛️ 社會", q:"台灣第一個大型電子產品是什麼帶來的改變？", o:["收音機","電視","電腦","手機"], a:1 },
  ...
  { s:"🤝 品德", q:"做錯事了應該？", o:["說謊掩蓋","逃走","誠實道歉並改正","怪別人"], a:1 },
  ...
  { s:"🤝 品德", q:"用餐後應該怎麼對待桌面？", o:["留著等別人清理","留下一點食物","自己清理乾淨","把食物推到地上"], a:1 },
  ...
  { s:"🤝 品德", q:"答應別人的事情如果做不到，應該？", o:["假裝忘記","直接消失","提前告知並道歉","找藉口推托"], a:1 },
