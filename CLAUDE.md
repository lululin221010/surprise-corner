...
| 角色 | 動作 |
|------|------|
| **C**（網頁版） | 討論完產出新版 HTML → 妹下載後存到 Google Drive `總策畫\` |
| **CC**（終端機） | 直接讀 `G:\我的雲端硬碟\總策畫\` 取得最新版，更新記憶 |

**妹給「最新版」時的標準流程：**
1. 妹說「這是最新版」並告知檔名
2. CC 讀 `G:\我的雲端硬碟\總策畫\[檔名]`
3. CC 更新對應記憶檔（`memory/project_academy_plan_*.md` 等）
4. CC 確認記憶更新完畢
...
- 每週一 CC 協助整合：確認最新版後，舊版本可另存封存或刪除
...
|------|------|
| 心理學圖書館（6系列）| ✅ 已上線 |
| 角落植物誌 Corner Botany | 規劃中 | 台灣常見植物的驚人生存策略，首發《木棉的英雄帖》，溫暖科普+微距插圖 |
| 角落動物談 Corner Fauna | 規劃中 | 從魯魯到野外鄰居的內心世界，首發《貓店長的經營學》，幽默擬人療癒系 |
| 角落星空與大地 Corner Geo & Astro | 規劃中 | 腳下地理+頭頂星空，首發《九降風的味道：新竹地理與美味的祕密》 |
| 角落靈異與禁忌 Corner Occult | 規劃中 | 科學解釋不了的感覺，首發《深夜的低語：台灣都市傳說與心理投射》，神祕黑色幽默 |

> 品牌名稱：**角落百科**（Corner Encyclopedia）
> 各系列風格差異大，但共用「角落」品牌，形成完整知識宇宙
