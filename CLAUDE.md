...
新增待辦
- [ ] SS favicon：將 ico 檔放入 surprise-corner-src/public/favicon.ico 並確認 layout.js 有引用
- [ ] SS：/chat/lulu 和林悅說話頁「看小說」按鈕章節全上鎖，需與連載解鎖機制結合，已發布章節應可免費閱讀
魯魯來了：小說列表顯示「更新於 2026-03-26」，但進去 ebook 頁目錄「第一集：大搖大擺 2026-03-16」， 日期不符 3連載需確認同步,不標示預排
魯魯來了沒有留言系統
試看文章最下方免費章節廣告用卡片 設計有連載更新了喔來看看，還是去小舖找找驚喜？
- [ ] ST 數位商品下架邏輯：下架前檢查最後購買日，未滿1年不可下架；超過1年可下架並清除 UserPurchase 紀錄與 Blob 檔案
- [ ] ST/SS 數位商品文案：「永久閱讀」改為「購買後可隨時以購買 email 回溫內容，商品持續上架期間均有效」
2筆podcast ok需上架