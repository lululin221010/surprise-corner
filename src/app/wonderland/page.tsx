...
const zones = [
  ...
  { name: '冷知識',   icon: '🧊', desc: '99% 的人不知道的事，今天你知道了',     href: '/cold-knowledge', angle: -90 + STEP * 6, color: '#fb923c' },
]
    ...
    <div className="min-h-screen text-white overflow-x-hidden relative" style={{
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 mb-8">
          ...
          <ShareButtons title="SURPRISE CORNER 驚喜樂世界" content="好幾個神秘區域，每天都有新發現 💖" />
        </div>
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-lg text-purple-200/80">好幾個神秘區域，每天都有新發現 ❤️</p>
        </div>
