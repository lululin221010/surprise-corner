...
import type { Mission } from '../../experience/types';
import { missionEndingVariants } from '../missionV2';

export function ConclusionScreenV2({
  mission,
  collectedClueIds,
  deductionAnswers,
  trustValue,
  ...
  const ending = trustValue > 0 ? missionEndingVariants.warm : missionEndingVariants.neutral;
  ...
  return (
    <div className="mx-auto max-w-xl text-center">
      ...
      <div className="mb-8 rounded-lg border border-white/10 bg-white/5 p-4 text-left">
        <p className="mb-2 text-xs tracking-widest text-slate-500">{ending.title}</p>
        <p className="whitespace-pre-line text-sm leading-relaxed text-slate-300">{ending.summary}</p>
      </div>
