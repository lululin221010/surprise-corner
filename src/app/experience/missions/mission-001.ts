...
export const mission001: Mission = {
  ...
  deduction: {
    title: '案件公告欄',
    intro: '從選項裡挑最貼近你想法的一句，想到什麼先選什麼，隨時可以換。這不是要交卷的考卷——結案時會把你選的版本，跟後來確認的版本擺在一起給你看，沒有對錯評分。',
    blanks: [
      {
        id: 'blank-location',
      ...
      {
        id: 'blank-blame',
        promptBefore: '如果要用一句話形容整起事件，你會說這是',
        promptAfter: '。',
        correctOptionId: 'noone',
        correctExplanation: '每位目擊者說的都是自己看到的那一小段時間，單獨看像是互相矛盾，但把時間軸拼起來，其實每一段都是真的——沒有壞人，只是太多人同時在乎同一件事，卻沒有真的碰在一起。',
        options: [
          { id: 'noone', text: '一場因為太在意彼此、反而錯過彼此的意外' },
          { id: 'man', text: '一起有心人士蓄意造成的事件', misledByClueId: 'adult-man' },
          { id: 'meiling-self', text: '一次因為不聽話造成的麻煩', misledByClueId: 'stayed-behind' },
          { id: 'mall', text: '一次商場管理疏失造成的意外', misledByClueId: 'broadcastRecord' },
        ],
      },
    ],
  },
  reflectionEssay: {
    title: '回頭看看，你當時是怎麼想的？',
    intro: '在揭曉真相之前，先看看你自己剛才寫下的版本，跟後來確認的版本擺在一起，會是什麼樣子。',
    sections: [],
  },
  truth: {
    revealText:
      '15:40，商場表演結束。\n\n大量人潮同時離開中庭。\n\n父母回頭時，以為美玲仍跟在身後；美玲則以為父母只是往前走，很快就會回到剛才一起看表演的位置。\n\n父母開始沿著商場尋找孩子。\n\n美玲則一直留在自己認定的「原地」等待。\n\n沒有人故意離開。\n\n沒有人被帶走。\n\n沒有人說謊。\n\n真正錯過彼此的，是每個人心中的「原地」並不是同一個地方。\n\n父母相信自己看見孩子一直跟著。\n\n孩子相信父母一定會回來找自己。\n\n他們都沒有親眼確認。\n\n卻都把「我以為」，當成了「我看見」。\n\n保全最後在表演舞台旁找到美玲時，她第一句話不是「我迷路了」。\n\n而是：「爸爸媽媽是不是找不到我？」\n\n媽媽蹲下來抱住她，聲音還在抖：「妳怎麼會在這裡？我們不是說好在服務台等嗎？」\n\n美玲小聲說：「爸爸剛剛講的是這裡呀，這裡才是我們一起看表演的地方……」',
  },
  missionEnding: {
