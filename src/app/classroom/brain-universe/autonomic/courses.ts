...
一旦理解了機制，才能做出有意義的改變。`,
    ...
    cta: { text: '前往小舖購買 Vol.01 完整版（共10堂）', url: `${ST_BASE}/${VOL_IDS['01']}`, seriesNote: '自律神經學系 7冊・從了解到改變' },
  },
  {
...
心跳、呼吸、消化、免疫全都受影響，身體的「不舒服」不是你想像出來的。`,
    ...
    cta: { text: '前往小舖購買 Vol.02 完整版（共10堂）', url: `${ST_BASE}/${VOL_IDS['02']}`, seriesNote: '自律神經學系 7冊・從了解到改變' },
  },
  {
...
長期壓力讓交感神經難以下線，這是「睡了還是累」最常見但最被忽略的根本原因。`,
    ...
    cta: { text: '前往小舖購買 Vol.03 完整版（共10堂）', url: `${ST_BASE}/${VOL_IDS['03']}`, seriesNote: '自律神經學系 7冊・從了解到改變' },
  },
  {
...
把症狀當敵人會讓焦慮更嚴重，而焦慮本身又會製造更多症狀；理解之後，才能打破這個循環。`,
    ...
    cta: { text: '前往小舖購買 Vol.04 完整版（共10堂）', url: `${ST_BASE}/${VOL_IDS['04']}`, seriesNote: '自律神經學系 7冊・從了解到改變' },
  },
  {
...
了解機制不是為了焦慮，而是為了找到真正有效的介入點。`,
    ...
    cta: { text: '前往小舖購買 Vol.05 完整版（共10堂）', url: `${ST_BASE}/${VOL_IDS['05']}`, seriesNote: '自律神經學系 7冊・從了解到改變' },
  },
  {
...
疲憊不是一個模糊的整體感覺，把來源拆開來看，才知道哪裡可以調整。`,
    ...
    cta: { text: '前往小舖購買 Vol.06 完整版（共10堂）', url: `${ST_BASE}/${VOL_IDS['06']}`, seriesNote: '自律神經學系 7冊・從了解到改變' },
  },
  {
...
被排除、被忽視的感覺跟身體疼痛共用大腦迴路，這解釋了為什麼「想開一點」沒有那麼容易。`,
    ...
    cta: { text: '前往小舖購買 Vol.07 完整版（共10堂）', url: `${ST_BASE}/${VOL_IDS['07']}`, seriesNote: '自律神經學系 7冊・從了解到改變' },
  },
];
