...
const AI_SERIES = [
  ...
  { n: 7, emoji: '🛠️', title: 'DIY AI 實作', desc: '從免費工具到自架本地AI', href: '/classroom/ai-diy', live: true },
  { n: 8, emoji: '🛡️', title: 'AI世界局勢', desc: '安全、失控邊界、國家競爭', href: '/classroom/ai-safety', live: true },
  { n: 9, emoji: '🤖', title: '機器人／具身智能', desc: '機器人怎麼動、怎麼想、會取代誰', href: '/classroom/ai-robot', live: true },
];
      ...
      <div style={{ maxWidth: 680, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '1.8rem' }}>
          ...
          <p style={{ color: '#4b5563', fontSize: '0.92rem', marginTop: '0.5rem', lineHeight: 1.6 }}>
            9大系列，從AI原理到實作，全面理解AI時代。9大系列全部上線！
          </p>
        </div>
