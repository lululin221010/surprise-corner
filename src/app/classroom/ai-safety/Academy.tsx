'use client';
// 📄 路徑：src/app/classroom/ai-safety/Academy.tsx
...
const UNLOCK_KEYS: Record<string, string> = {
  'safety-upper': 'ss-safety-upper',
  'safety-lower': 'ss-safety-lower',
};

const PURCHASE_URLS: Record<string, string> = {
  'safety-upper': 'https://still-time-corner.vercel.app/digital/6a4e0bed7cc6e59bb60d4f27',
  'safety-lower': 'https://still-time-corner.vercel.app/digital/6a4e0bed7cc6e59bb60d4f28',
};
    ...
    return (
      <div className="classroom-content">
        ...
        <div className="classroom-breadcrumb" style={{ marginBottom: '1rem' }}>
          ...
          <button onClick={() => setActiveCourse(null)} className="classroom-back" style={{ fontSize: '12px' }}>AI世界局勢書院</button>
          <span style={{ margin: '0 0.4rem' }}>›</span>
